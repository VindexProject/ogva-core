...
This document provides guidelines for internationalization of the Ogva Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ogva_en.ts` remains unchanged.
