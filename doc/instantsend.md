...
This mechanism has been integrated into Bitcore-Node-Ogva which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dashpay/insight-api-ogva#web-socket-api](https://github.com/dashpay/insight-api-ogva#web-socket-api)
* API: [https://github.com/dashpay/insight-api-ogva#instantsend-transactions](https://github.com/dashpay/insight-api-ogva#instantsend-transactions)
