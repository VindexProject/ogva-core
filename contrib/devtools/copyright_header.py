...
Arguments:
    <base_directory> - The base directory of a Ogva Core source code repository.
...
Arguments:
    <base_directory> - The base directory of Ogva Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Ogva Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Ogva
