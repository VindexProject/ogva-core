# Linearize
Construct a linear, no-fork, best version of the Ogva blockchain.
...
JSON-RPC server. Running `ogvad` or `ogva-qt -server` will be sufficient.
...
* `input`: ogvad blocks/ directory containing blkNNNNN.dat
