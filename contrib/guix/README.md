# Bootstrappable Ogva Core Builds

This directory contains the files necessary to perform bootstrappable Ogva
Core builds.
...
To build Ogva Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/ogva-detached-sigs> ./contrib/guix/guix-codesign
```
