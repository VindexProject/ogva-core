...
#ifndef OGVA_CRYPTO_BLS_H
#define OGVA_CRYPTO_BLS_H
...
// bls-ogva uses relic, which may define DEBUG and ERROR, which leads to many warnings in some build setups
#undef ERROR
#undef DEBUG
