...
{
    const char* pszTimestamp = "The Times 01/Dec/2024 Ogva Network is name of the game for new generation of firms";
    const CScript genesisOutputScript = CScript() << ParseHex("043a1db3a3d8aa92f8ba40b3641992e0bb326f648eb48ae432a986ed8c64544241a5d1372c56b5fdfac2ae40b01ba979c3d5ba402fcb67ddf7f25ae7b78e408faa") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsStartBlock = 8640; // not true, but it's ok as long as it's less then nMasternodePaymentsIncreaseBlock
        consensus.nMasternodePaymentsIncreaseBlock = 158000; // disabled
        ...
        consensus.BIP147Height = 110;
        consensus.CSVHeight = 110;
        consensus.DIP0001Height = 110;
        consensus.DIP0003Height = 4320;
        consensus.DIP0003EnforcementHeight = 4320;
        consensus.DIP0003EnforcementHash = uint256();
        consensus.DIP0008Height = 110;
        consensus.BRRHeight = 999999;
        consensus.DIP0020Height = 110;
        consensus.DIP0024Height = 110;
        consensus.DIP0024QuorumsHeight = 110;
        consensus.V19Height = 110;
        consensus.MinBIP9WarningHeight = 110; // V19 activation height + miner confirmation window
        consensus.powLimit = uint256S("00000ffff0000000000000000000000000000000000000000000000000000000"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Ogva: 1 day
        consensus.nPowTargetSpacing = 1 * 60; // Ogva: 1 minutes
        ...
        consensus.defaultAssumeValid = uint256S("0x000000ccc242811b26740ddbc97b3a96a61a8ae0dea3121e0a654d69cb6e71d4"); // Genesis block
         ...
         */
        pchMessageStart[0] = 0x72; // O
        pchMessageStart[1] = 0x74; // G
        pchMessageStart[2] = 0x6d; // V
        pchMessageStart[3] = 0x2e; // A
        nDefaultPort = 40112;
        ...
        genesis = CreateGenesisBlock(1733011200, 3600216, 0x1e00ffff, 1, 3000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x000000ccc242811b26740ddbc97b3a96a61a8ae0dea3121e0a654d69cb6e71d4"));
        assert(genesis.hashMerkleRoot == uint256S("0xe10bdb192ab0a5ca346c37d7fd936b4feb585a10bccf3d0dba6d64b80991a056"));
        ...
        vSeeds.emplace_back("dnsseed.ogva.net");

        // Ogva addresses start with 'A'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,23);
        // Ogva script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,15);
        // Ogva private keys start with 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,75);
        // Ogva BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Ogva BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Ogva BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"AbGVNDJLdfQGjZWJ1Btnq6sDR2gVZTPAsK"};
        nMinSporkKeys = 1;
        ...
        checkpointData = {
            {
                {0, uint256S("0x000000ccc242811b26740ddbc97b3a96a61a8ae0dea3121e0a654d69cb6e71d4")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Ogva: 1 day
        consensus.nPowTargetSpacing = 90; // Ogva: 90 seconds for testnet
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000f7159f4a43c56f137eb5724cafb7fd69db327493eebef5706acbee4402a"); // Genesis block
        
        pchMessageStart[0] = 0x74; // t
        pchMessageStart[1] = 0x4f; // O
        pchMessageStart[2] = 0x53; // G
        pchMessageStart[3] = 0x4d; // V
        nDefaultPort = 41112;
        ...
        genesis = CreateGenesisBlock(1690666206, 4653, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x00000f7159f4a43c56f137eb5724cafb7fd69db327493eebef5706acbee4402a"));
        assert(genesis.hashMerkleRoot == uint256S("0x7ee736a586189f99932940035631d7233f81cba2f9eb871415df24aa1763db99"));
        ...
        vSeeds.emplace_back("testnet-seed.ogva.net"); // Just a static list of stable node(s), only supports x9

        // Testnet Ogva addresses start with 'V'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,70);
        // Testnet Ogva script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,12);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Ogva BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Ogva BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Ogva BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"VHqRiG7v6G9tRJjd8SPpUbgSUhJeEqH7sf"};
        nMinSporkKeys = 1;

        std::vector<DevfeeRewardStructure> rewardStructures = {  {INT_MAX, 5}  }; // 5% dev fee
        consensus.nDevfeePayment = DevfeePayment(rewardStructures, 100, "VTjmQyRqDni9Tx379qVUZuVb4StC8gzSLj");

        checkpointData = {
            {
                {0, uint256S("0x00000f7159f4a43c56f137eb5724cafb7fd69db327493eebef5706acbee4402a")},
            }
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 1
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Ogva: 1 day
        consensus.nPowTargetSpacing = 1.5 * 60; // Ogva: 1.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("ogva.net",  "devnet-seed.ogva.net"));

        // Devnet Ogva addresses start with 's'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,125);
        // Devnet Ogva script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,12);
        // Devnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Devnet Ogva BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Devnet Ogva BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Devnet Ogva BIP44 coin type is '1' (All coin's devnet default)
        nExtCoinType = 1;
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.powLimit = uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 1
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Ogva: 1 day
        consensus.nPowTargetSpacing = 1.5 * 60; // Ogva: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x7e1c09bca3cdc568f7e1be4cc9cee35fa3439d4e72f3ff2a421f2eb2fb7f4b4f"));
        assert(genesis.hashMerkleRoot == uint256S("0x7ee736a586189f99932940035631d7233f81cba2f9eb871415df24aa1763db99"));
        ...
        // Regtest Ogva addresses start with 's'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,125);
        // Regtest Ogva script addresses start with '5' or '6'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,12);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Ogva BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Ogva BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Ogva BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
void CChainParams::UpdateLLMQParams(size_t totalMnCount, int height) {
    ...
    if ((lastCheckHeight < height && (lastCheckMnCount != totalMnCount) &&
        ...
        if (height >= 10080 && totalMnCount < 80)
            consensus.llmqs[Consensus::LLMQ_60_75] = Consensus::llmq_10_75;
    }
}
