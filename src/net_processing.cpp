 ...
 *  We have 4 times smaller block times in Ogva, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Ogva Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // OGVA this code also handles non-TXs (Ogva specific messages)
