    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  ogva-qt [command-line options]                     \n";
...
All the Ogva in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 OGVA, 0.01 OGVA, 0.1 OGVA, 1 OGVA and 10 OGVA -- sort of like the paper money you use every day.</li> \
