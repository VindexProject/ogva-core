...
/** Utility functions used by the Ogva Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "ogva:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load ogva specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a ogva specific theme is activated (light/dark).*/
