...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn)
{
    ...
    DevfeePayment developmentPayment = chainparams.GetConsensus().nDevelopmentPayment;
    developmentPayment.FillDevfeePayment(coinbaseTx, nHeight, blockSubsidy, pblock->txoutDevelopment);    
    
    DevfeePayment communityPayment = chainparams.GetConsensus().nCommunityPayment;
    communityPayment.FillDevfeePayment(coinbaseTx, nHeight, blockSubsidy, pblock->txoutCommunity);
