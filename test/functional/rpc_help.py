...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: Ogva's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'Ogva', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
