...
from test_framework.messages import ogvahash, hash256
...
def ogvahash_reversed(byte_str):
    return ogvahash(byte_str)[::-1]
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], ogvahash_reversed(block[:80]).hex())
