...
"""Test the ogva specific ZMQ notification interfaces."""
...
class OgvaZMQTest (OgvaTestFramework):
    def set_test_params(self):
        ...
        self.set_ogva_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that ogvad has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all ogva related ZMQ publisher
