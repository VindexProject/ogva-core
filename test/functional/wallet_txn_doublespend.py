...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 OGVA: //Cunit
        ...
        # First: use raw transaction API to send 12400 OGVA to node1_address, //Cunit
        # but don't broadcast:
        ...
        # Create two spends using 1 500 OGVA coin each //Cunit
        ...
        # Node0's balance should be starting balance, plus 500 OGVA for another //Cunit
        ...
        # Node0's total balance should be starting balance, plus 1000 OGVA for //Cunit
