...
"""Verify that starting ogvad with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ogvad with -h for help text")
        ...
        self.log.info("Start ogvad with -version for version information")
        ...
        self.log.info("Start ogvadd with -fakearg to make sure it does not start")
